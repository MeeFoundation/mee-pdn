...
- **Links are clickable and relative to `.code-review/`**: `[fs.rs:827](../crates/pdn-store/src/store/fs.rs#L827)`, `[core/spec.md](../mia-docs/openspec/specs/components/mee-pdn/pdn-node/core/spec.md)`.
